...
module main (
    ...
    input logic reset,
    output logic done,
    output logic [1:0] inp_addr0,
    output logic [7:0] inp_write_data,
    output logic inp_write_en,
    output logic inp_clk,
    input logic [7:0] inp_read_data,
    input logic inp_done
);
    logic [7:0] add0_left;
    logic [7:0] add0_right;
    logic [7:0] add0_out;
    logic [7:0] r0_in;
    logic r0_write_en;
    logic r0_clk;
    ...
    logic fsm_done;
    logic read_m0_go_in;
    logic read_m0_go_out;
    logic read_m0_done_in;
    logic read_m0_done_out;
    logic read_m1_go_in;
    logic read_m1_go_out;
    logic read_m1_done_in;
    logic read_m1_done_out;
    logic do_add_go_in;
    logic do_add_go_out;
    ...
    initial begin
        ...
        fsm_reset = 1'd0;
        read_m0_go_in = 1'd0;
        read_m0_done_in = 1'd0;
        read_m1_go_in = 1'd0;
        read_m1_done_in = 1'd0;
        do_add_go_in = 1'd0;
        do_add_done_in = 1'd0;
        tdcc_go_in = 1'd0;
        tdcc_done_in = 1'd0;
    ...
    assign inp_addr0 =
     read_m0_go_out ? 2'd0 :
     read_m1_go_out ? 2'd1 :
     do_add_go_out ? 2'd2 : 2'd0;
    assign inp_clk = clk;
    assign inp_write_data =
     do_add_go_out ? add0_out : 8'd0;
    assign inp_write_en = do_add_go_out;
    assign add0_left =
     do_add_go_out ? r0_out : 8'd0;
    assign add0_right =
     do_add_go_out ? r1_out : 8'd0;
    assign do_add_done_in = inp_done;
    assign do_add_go_in = ~do_add_done_out & fsm_out == 2'd2 & tdcc_go_out;
    assign fsm_clk = clk;
    assign fsm_in =
     fsm_out == 2'd3 ? 2'd0 :
     fsm_out == 2'd0 & read_m0_done_out & tdcc_go_out ? 2'd1 :
     fsm_out == 2'd1 & read_m1_done_out & tdcc_go_out ? 2'd2 :
     fsm_out == 2'd2 & do_add_done_out & tdcc_go_out ? 2'd3 : 2'd0;
    assign fsm_reset = reset;
    assign fsm_write_en = fsm_out == 2'd3 | fsm_out == 2'd0 & read_m0_done_out & tdcc_go_out | fsm_out == 2'd1 & read_m1_done_out & tdcc_go_out | fsm_out == 2'd2 & do_add_done_out & tdcc_go_out;
    assign r0_clk = clk;
    assign r0_in =
     read_m0_go_out ? inp_read_data : 8'd0;
    assign r0_reset = reset;
    assign r0_write_en = read_m0_go_out;
    assign r1_clk = clk;
    assign r1_in =
     read_m1_go_out ? inp_read_data : 8'd0;
    assign r1_reset = reset;
    assign r1_write_en = read_m1_go_out;
    assign read_m0_done_in = r0_done;
    assign read_m0_go_in = ~read_m0_done_out & fsm_out == 2'd0 & tdcc_go_out;
    assign read_m1_done_in = r1_done;
    assign read_m1_go_in = ~read_m1_done_out & fsm_out == 2'd1 & tdcc_go_out;
