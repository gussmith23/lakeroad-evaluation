...
def task_calyx_setup_xilinx_ultrascale_plus_vivado():
    ...
    return _make_setup_calyx_task(
        filepaths=[
            ...
            utils.output_dir() / "baseline" / "vivado" / "shl32_2.sv",
            utils.output_dir() / "baseline" / "vivado" / "shru4_2.sv",
            utils.output_dir() / "baseline" / "vivado" / "shru32_2.sv",
            utils.output_dir() / "baseline" / "vivado" / "std_div_pipe_4.sv",
            utils.output_dir() / "baseline" / "vivado" / "std_div_pipe_32.sv",
