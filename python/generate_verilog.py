...
def generate_designs(design_dir: Union[str, Path]):
    ...
    inputs_dict = {
        "mult": [["a", "b"], ["xilinx", "intel", "lattice", "xilinx-7-series"]],
        "muladd": [["a", "b", "c"], ["xilinx", "lattice", "xilinx-7-series"]],
        "mulsub": [["a", "b", "c"], ["xilinx", "lattice", "xilinx-7-series"]],
        "addmuladd": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        "addmulsub": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        "submuladd": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        "submulsub": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # Not valid -- turns out you can't use logic ops when using multiplier.
        # "addmuland": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # "submuland": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # "addmulor": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        "presubmul": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # Not valid -- turns out you can't use logic ops when using multiplier.
        # "submulor": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # "addmulxor": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        # "submulxor": [["a", "b", "c", "d"], ["xilinx", "xilinx-7-series"]],
        "preaddmul": [["a", "b", "d"], ["xilinx", "xilinx-7-series"]],
