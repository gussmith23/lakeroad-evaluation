...
def generate_designs(design_dir: Union[str, Path]):
    ...
    inputs_dict = {
        "mult": [["a", "b"], ["xilinx", "intel", "lattice", "virtex"]],
        "muladd": [["a", "b", "c"], ["xilinx", "lattice", "virtex"]],
        "mulsub": [["a", "b", "c"], ["xilinx", "lattice", "virtex"]],
        "addmuladd": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        "addmulsub": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        "submuladd": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        "submulsub": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # Not valid -- turns out you can't use logic ops when using multiplier.
        # "addmuland": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # "submuland": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # "addmulor": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        "presubmul": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # Not valid -- turns out you can't use logic ops when using multiplier.
        # "submulor": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # "addmulxor": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        # "submulxor": [["a", "b", "c", "d"], ["xilinx", "virtex"]],
        "preaddmul": [["a", "b", "d"], ["xilinx", "virtex"]],
