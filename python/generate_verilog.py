...
def generate_designs(design_dir: Union[str, Path]):
    ...
    inputs_dict = {
        ...
        "muladd": [["a", "b", "c"], ["xilinx", "lattice", "intel"]],
        "mulsub": [["a", "b", "c"], ["xilinx", "lattice", "intel"]],
        "addmuladd": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "addmulsub": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "submuladd": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "submulsub": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "addmuland": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "submuland": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "addmulor": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "presubmul": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "submulor": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "addmulxor": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "submulxor": [["a", "b", "c", "d"], ["xilinx", "intel"]],
        "preaddmul": [["a", "b", "d"], ["xilinx", "intel"]],
        # "muladdadd": [["a", "b", "c", "d"], ["lattice"]],
        # "muladdsub": [["a", "b", "c", "d"], ["lattice"]],
        # "mulsubadd": [["a", "b", "c", "d"], ["lattice"]],
        # "mulsubsub": [["a", "b", "c", "d"], ["lattice"]],
        "muland": [["a", "b", "c"], ["lattice", "intel"]],
        "mulor": [["a", "b", "c"], ["lattice", "intel"]],
        "mulxor": [["a", "b", "c"], ["lattice", "intel"]],
    }
