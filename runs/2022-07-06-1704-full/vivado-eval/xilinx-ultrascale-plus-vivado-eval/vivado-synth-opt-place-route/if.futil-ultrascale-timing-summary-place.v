...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//if.futil-ultrascale-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.295        0.000                      0                    6        0.054        0.000                      0                    6        2.225        0.000                       0                     4  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.295        0.000                      0                    6        0.054        0.000                      0                    6        2.225        0.000                       0                     4  
...
Slack (MET) :             0.054ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    SLICE_X26Y91         FDRE (Prop_HFF_SLICEL_C_Q)
                         ...
                         net (fo=9, estimated)        0.037     0.089    comb_reg/Q[1]
    SLICE_X26Y91         LUT6 (Prop_G6LUT_SLICEL_I5_O)
                                                      0.014     0.103 r  comb_reg/out[0]_i_1__0/O
                         net (fo=1, routed)           0.016     0.119    fsm/D[0]
    SLICE_X26Y91         FDRE                                         r  fsm/out_reg[0]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=3, unset)            0.019     0.019    fsm/clk
    SLICE_X26Y91         FDRE                                         r  fsm/out_reg[0]/C
                         clock pessimism              0.000     0.019    
    SLICE_X26Y91         FDRE (Hold_GFF_SLICEL_C_D)
