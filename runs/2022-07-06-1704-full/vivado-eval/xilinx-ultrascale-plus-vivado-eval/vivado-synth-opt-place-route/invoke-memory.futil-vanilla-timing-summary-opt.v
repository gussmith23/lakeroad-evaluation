...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke-memory.futil-vanilla-timing-summary-opt.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      4.222        0.000                      0                   15        0.079        0.000                      0                   15        2.225        0.000                       0                     9  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 4.222        0.000                      0                   15        0.079        0.000                      0                   15        2.225        0.000                       0                     9  
...
Slack (MET) :             0.079ns  (arrival time - required time)
  Source:                 copy0/comb_reg/out_reg[0]/C
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  ...
  -------------------------------------------------------------------    -------------------
                         FDRE (Prop_FDRE_C_Q)         0.038     0.038 r  copy0/comb_reg/out_reg[0]/Q
                         net (fo=3, unplaced)         0.048     0.086    copy0/N/comb_reg_out
                         LUT5 (Prop_LUT5_I4_O)        0.023     0.109 r  copy0/N/out[0]_i_1__1/O
                         net (fo=1, unplaced)         0.016     0.125    copy0/comb_reg/out_reg[0]_0
  ...
  -------------------------------------------------------------------    -------------------
                         ...
                         FDRE (Hold_FDRE_C_D)         0.046     0.046    copy0/comb_reg/out_reg[0]
  -------------------------------------------------------------------
                         required time                         -0.046    
                         arrival time                           0.125    
  -------------------------------------------------------------------
