...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//pow.futil-ultrascale-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.195        0.000                      0                  427        0.056        0.000                      0                  427        2.225        0.000                       0                   162  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.195        0.000                      0                  427        0.056        0.000                      0                  427        2.225        0.000                       0                   162  
...
Slack (MET) :             2.195ns  (required time - arrival time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    DSP48E2_X3Y49        DSP_OUTPUT (Prop_DSP_OUTPUT_DSP48E2_ALU_OUT[47]_PCOUT[47])
                         ...
                         net (fo=1, estimated)        0.042     2.126    p/mul/comp/out_tmp_reg/PCIN[47]
...
Slack (MET) :             0.056ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X39Y122        FDRE                                         r  p/mul/comp/done_buf_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X39Y122        FDRE (Prop_EFF_SLICEM_C_Q)
                                                      0.038     0.051 r  p/mul/comp/done_buf_reg[1]/Q
                         net (fo=2, estimated)        0.071     0.122    p/mul/comp/done_buf_reg_n_0_[1]
    SLICE_X39Y122        FDRE                                         r  p/mul/comp/done_buf_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=177, unset)          0.019     0.019    p/mul/comp/clk
    SLICE_X39Y122        FDRE                                         r  p/mul/comp/done_buf_reg[2]/C
                         clock pessimism              0.000     0.019    
    SLICE_X39Y122        FDRE (Hold_EFF2_SLICEM_C_D)
...
Min Period        n/a     DSP_OUTPUT/CLK  n/a            0.750         5.000       4.250      DSP48E2_X3Y48  p/mul/comp/out0/DSP_OUTPUT_INST/CLK
Low Pulse Width   Slow    FDRE/C          n/a            0.275         2.500       2.225      SLICE_X41Y128  base_reg/done_reg/C
High Pulse Width  Slow    FDRE/C          n/a            0.275         2.500       2.225      SLICE_X41Y128  base_reg/done_reg/C
