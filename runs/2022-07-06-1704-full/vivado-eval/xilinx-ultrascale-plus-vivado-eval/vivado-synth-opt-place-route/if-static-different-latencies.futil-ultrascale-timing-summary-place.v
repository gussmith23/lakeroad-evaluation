...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//if-static-different-latencies.futil-ultrascale-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.829        0.000                      0                   11        0.041        0.000                      0                   11        2.225        0.000                       0                     9  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.829        0.000                      0                   11        0.041        0.000                      0                   11        2.225        0.000                       0                     9  
...
Slack (MET) :             0.041ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=8, unset)            0.012     0.012    t2/clk
    SLICE_X32Y117        FDRE                                         r  t2/done_reg/C
  -------------------------------------------------------------------    -------------------
    SLICE_X32Y117        FDRE (Prop_BFF_SLICEL_C_Q)
                                                      0.039     0.051 r  t2/done_reg/Q
                         net (fo=1, estimated)        0.024     0.075    fsm/t2_done
    SLICE_X32Y117        LUT5 (Prop_D6LUT_SLICEL_I4_O)
                                                      0.014     0.089 r  fsm/done_i_1__0/O
                         net (fo=1, routed)           0.016     0.105    t3/t3_write_en
    SLICE_X32Y117        FDRE                                         r  t3/done_reg/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=8, unset)            0.018     0.018    t3/clk
    SLICE_X32Y117        FDRE                                         r  t3/done_reg/C
                         clock pessimism              0.000     0.018    
    SLICE_X32Y117        FDRE (Hold_DFF_SLICEL_C_D)
                                                      0.046     0.064    t3/done_reg
  -------------------------------------------------------------------
                         required time                         -0.064    
                         arrival time                           0.105    
  -------------------------------------------------------------------
