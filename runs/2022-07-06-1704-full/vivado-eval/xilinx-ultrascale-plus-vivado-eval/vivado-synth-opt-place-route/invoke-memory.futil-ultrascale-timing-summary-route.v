...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke-memory.futil-ultrascale-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.296        0.000                      0                   15        0.061        0.000                      0                   15        2.225        0.000                       0                     9  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.296        0.000                      0                   15        0.061        0.000                      0                   15        2.225        0.000                       0                     9  
...
Slack (MET) :             0.061ns  (arrival time - required time)
  Source:                 copy0/N/out_reg[2]/C
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Destination:            copy0/N/out_reg[2]/D
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Path Group:             clk
  ...
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X22Y91         FDRE                                         r  copy0/N/out_reg[2]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X22Y91         FDRE (Prop_CFF_SLICEL_C_Q)
                                                      0.039     0.051 r  copy0/N/out_reg[2]/Q
                         net (fo=3, routed)           0.028     0.079    copy0/fsm/Q[2]
    SLICE_X22Y91         LUT6 (Prop_C6LUT_SLICEL_I5_O)
                                                      0.014     0.093 r  copy0/fsm/C_LUT_2_i_1/O
                         net (fo=1, routed)           0.008     0.101    copy0/add/_impl/a[2]
    SLICE_X22Y91         CARRY8 (Prop_CARRY8_SLICEL_S[2]_O[2])
                                                      0.017     0.118 r  copy0/add/_impl/carry_8/O[2]
                         net (fo=1, routed)           0.007     0.125    copy0/N/out0[2]
    SLICE_X22Y91         FDRE                                         r  copy0/N/out_reg[2]/D
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X22Y91         FDRE (Hold_CFF_SLICEL_C_D)
                                                      0.046     0.064    copy0/N/out_reg[2]
  -------------------------------------------------------------------
                         required time                         -0.064    
                         arrival time                           0.125    
  -------------------------------------------------------------------
