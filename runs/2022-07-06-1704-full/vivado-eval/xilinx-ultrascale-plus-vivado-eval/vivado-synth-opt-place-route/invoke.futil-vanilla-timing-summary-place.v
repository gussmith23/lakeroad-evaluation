...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke.futil-vanilla-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.221        0.000                      0                  386        0.048        0.000                      0                  386        2.225        0.000                       0                   111  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.221        0.000                      0                  386        0.048        0.000                      0                  386        2.225        0.000                       0                   111  
...
Slack (MET) :             2.221ns  (required time - arrival time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    DSP48E2_X2Y24        DSP_A_B_DATA                                 r  exp0/mul/comp/out0__0/DSP_A_B_DATA_INST/CLK
  -------------------------------------------------------------------    -------------------
    DSP48E2_X2Y24        DSP_A_B_DATA (Prop_DSP_A_B_DATA_DSP48E2_CLK_B2_DATA[17])
    ...
    DSP48E2_X2Y24        DSP_PREADD_DATA (Prop_DSP_PREADD_DATA_DSP48E2_B2_DATA[17]_B2B1[17])
    ...
    DSP48E2_X2Y24        DSP_MULTIPLIER (Prop_DSP_MULTIPLIER_DSP48E2_B2B1[17]_U[43])
    ...
    DSP48E2_X2Y24        DSP_OUTPUT (Prop_DSP_OUTPUT_DSP48E2_ALU_OUT[47]_PCOUT[47])
                         ...
                         net (fo=1, estimated)        0.016     2.100    exp0/mul/comp/out_tmp_reg/PCIN[47]
    DSP48E2_X2Y25        DSP_ALU (Prop_DSP_ALU_DSP48E2_PCIN[47]_ALU_OUT[0])
    ...
    DSP48E2_X2Y25        DSP_OUTPUT                                   r  exp0/mul/comp/out_tmp_reg/DSP_OUTPUT_INST/ALU_OUT[0]
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        5.000     5.000 r  
                                                      0.000     5.000 r  clk (IN)
                         net (fo=126, unset)          0.044     5.044    exp0/mul/comp/out_tmp_reg/CLK
    DSP48E2_X2Y25        DSP_OUTPUT                                   r  exp0/mul/comp/out_tmp_reg/DSP_OUTPUT_INST/CLK
                         clock pessimism              0.000     5.044    
                         clock uncertainty           -0.035     5.009    
    DSP48E2_X2Y25        DSP_OUTPUT (Setup_DSP_OUTPUT_DSP48E2_CLK_ALU_OUT[0])
...
Slack (MET) :             0.048ns  (arrival time - required time)
  Source:                 exp0/mul/comp/done_buf_reg[1]/C
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Destination:            exp0/mul/comp/done_buf_reg[2]/D
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Path Group:             clk
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=126, unset)          0.013     0.013    exp0/mul/comp/clk
    SLICE_X29Y65         FDRE                                         r  exp0/mul/comp/done_buf_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X29Y65         FDRE (Prop_AFF_SLICEM_C_Q)
                                                      0.038     0.051 r  exp0/mul/comp/done_buf_reg[1]/Q
                         net (fo=2, estimated)        0.063     0.114    exp0/mul/comp/done_buf_reg_n_0_[1]
    SLICE_X29Y65         FDRE                                         r  exp0/mul/comp/done_buf_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=126, unset)          0.019     0.019    exp0/mul/comp/clk
    SLICE_X29Y65         FDRE                                         r  exp0/mul/comp/done_buf_reg[2]/C
                         clock pessimism              0.000     0.019    
    SLICE_X29Y65         FDRE (Hold_AFF2_SLICEM_C_D)
                                                      0.047     0.066    exp0/mul/comp/done_buf_reg[2]
  -------------------------------------------------------------------
                         required time                         -0.066    
                         arrival time                           0.114    
  -------------------------------------------------------------------
...
Min Period        n/a     DSP_OUTPUT/CLK  n/a            0.750         5.000       4.250      DSP48E2_X2Y26  exp0/mul/comp/out0/DSP_OUTPUT_INST/CLK
Low Pulse Width   Slow    FDRE/C          n/a            0.275         2.500       2.225      SLICE_X29Y59   a_read0_0/done_reg/C
High Pulse Width  Slow    FDRE/C          n/a            0.275         2.500       2.225      SLICE_X29Y59   a_read0_0/done_reg/C
