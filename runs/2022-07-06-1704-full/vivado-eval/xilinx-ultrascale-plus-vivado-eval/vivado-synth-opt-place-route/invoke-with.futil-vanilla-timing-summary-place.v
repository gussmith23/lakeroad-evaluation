...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke-with.futil-vanilla-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.221        0.000                      0                  153        0.048        0.000                      0                  153        2.225        0.000                       0                    26  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.221        0.000                      0                  153        0.048        0.000                      0                  153        2.225        0.000                       0                    26  
...
Slack (MET) :             2.221ns  (required time - arrival time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    DSP48E2_X2Y46        DSP_OUTPUT (Prop_DSP_OUTPUT_DSP48E2_ALU_OUT[47]_PCOUT[47])
                         ...
                         net (fo=1, estimated)        0.016     2.100    m/comp/out_tmp_reg/PCIN[47]
...
Slack (MET) :             0.048ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=41, unset)           0.013     0.013    m/comp/clk
    SLICE_X27Y118        FDRE                                         r  m/comp/done_buf_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X27Y118        FDRE (Prop_EFF_SLICEL_C_Q)
                                                      0.039     0.052 r  m/comp/done_buf_reg[1]/Q
                         net (fo=2, estimated)        0.062     0.114    m/comp/done_buf_reg_n_0_[1]
    SLICE_X27Y118        FDRE                                         r  m/comp/done_buf_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=41, unset)           0.019     0.019    m/comp/clk
    SLICE_X27Y118        FDRE                                         r  m/comp/done_buf_reg[2]/C
                         clock pessimism              0.000     0.019    
    SLICE_X27Y118        FDRE (Hold_EFF2_SLICEL_C_D)
