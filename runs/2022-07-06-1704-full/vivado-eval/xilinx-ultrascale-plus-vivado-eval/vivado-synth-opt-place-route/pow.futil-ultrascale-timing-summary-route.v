...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//pow.futil-ultrascale-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.195        0.000                      0                  427        0.050        0.000                      0                  427        2.225        0.000                       0                   162  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.195        0.000                      0                  427        0.050        0.000                      0                  427        2.225        0.000                       0                   162  
...
Slack (MET) :             0.050ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    SLICE_X39Y122        FDRE (Prop_EFF_SLICEM_C_Q)
                         ...
                         net (fo=2, routed)           0.065     0.116    p/mul/comp/done_buf_reg_n_0_[1]
