...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//while.futil-vanilla-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.504        0.000                      0                    8        0.082        0.000                      0                    8        2.225        0.000                       0                     5  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.504        0.000                      0                    8        0.082        0.000                      0                    8        2.225        0.000                       0                     5  
...
Slack (MET) :             0.082ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=4, unset)            0.013     0.013    fsm/clk
    SLICE_X35Y111        FDRE                                         r  fsm/out_reg[2]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X35Y111        FDRE (Prop_GFF_SLICEL_C_Q)
                                                      0.039     0.052 f  fsm/out_reg[2]/Q
                         net (fo=73, estimated)       0.057     0.109    fsm/fsm_out[2]
    SLICE_X35Y111        LUT6 (Prop_G6LUT_SLICEL_I4_O)
                                                      0.022     0.131 r  fsm/out[2]_i_2/O
                         net (fo=1, routed)           0.016     0.147    fsm/out[2]_i_2_n_0
