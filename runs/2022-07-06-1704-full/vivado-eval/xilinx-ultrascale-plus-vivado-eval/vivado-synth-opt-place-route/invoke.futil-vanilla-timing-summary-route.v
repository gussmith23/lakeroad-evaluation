...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke.futil-vanilla-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.221        0.000                      0                  386        0.058        0.000                      0                  386        2.225        0.000                       0                   111  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.221        0.000                      0                  386        0.058        0.000                      0                  386        2.225        0.000                       0                   111  
...
Slack (MET) :             0.058ns  (arrival time - required time)
  ...
  Destination:            comb_reg/done_reg/D
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Path Group:             clk
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=126, unset)          0.013     0.013    comb_reg/clk
    SLICE_X29Y59         FDRE                                         r  comb_reg/done_reg/C
  -------------------------------------------------------------------    -------------------
    SLICE_X29Y59         FDRE (Prop_DFF_SLICEM_C_Q)
                                                      0.039     0.052 f  comb_reg/done_reg/Q
                         net (fo=5, routed)           0.031     0.083    fsm/comb_reg_done
    SLICE_X29Y59         LUT6 (Prop_D6LUT_SLICEM_I5_O)
                                                      0.014     0.097 r  fsm/done_i_1/O
                         net (fo=1, routed)           0.026     0.123    comb_reg/cond00_go_in
    SLICE_X29Y59         FDRE                                         r  comb_reg/done_reg/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=126, unset)          0.019     0.019    comb_reg/clk
    SLICE_X29Y59         FDRE                                         r  comb_reg/done_reg/C
                         clock pessimism              0.000     0.019    
    SLICE_X29Y59         FDRE (Hold_DFF_SLICEM_C_D)
                                                      0.046     0.065    comb_reg/done_reg
  -------------------------------------------------------------------
                         required time                         -0.065    
                         arrival time                           0.123    
  -------------------------------------------------------------------
