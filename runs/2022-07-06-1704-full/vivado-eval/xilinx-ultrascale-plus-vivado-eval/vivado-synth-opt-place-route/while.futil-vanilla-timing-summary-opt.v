...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//while.futil-vanilla-timing-summary-opt.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.566        0.000                      0                    8        0.093        0.000                      0                    8        2.225        0.000                       0                     5  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.566        0.000                      0                    8        0.093        0.000                      0                    8        2.225        0.000                       0                     5  
...
Slack (MET) :             0.093ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         ...
                         net (fo=3, unplaced)         0.050     0.088    comb_reg/comb_reg_out
                         LUT3 (Prop_LUT3_I0_O)        0.035     0.123 r  comb_reg/out[0]_i_1__0/O
                         net (fo=1, unplaced)         0.016     0.139    comb_reg/out[0]_i_1__0_n_0
                         FDRE                                         r  comb_reg/out_reg[0]/D
  -------------------------------------------------------------------    -------------------
