...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//unsigned-dot-product.futil-vanilla-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      4.055        0.000                      0                   22        0.044        0.000                      0                   22        2.225        0.000                       0                    14  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 4.055        0.000                      0                   22        0.044        0.000                      0                   22        2.225        0.000                       0                    14  
...
Slack (MET) :             0.044ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=13, unset)           0.012     0.012    comb_reg/clk
    SLICE_X27Y89         FDRE                                         r  comb_reg/out_reg[0]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X27Y89         FDRE (Prop_DFF_SLICEL_C_Q)
                                                      0.039     0.051 r  comb_reg/out_reg[0]/Q
                         net (fo=3, estimated)        0.027     0.078    fsm/comb_reg_out
    SLICE_X27Y89         LUT6 (Prop_D6LUT_SLICEL_I5_O)
                                                      0.014     0.092 r  fsm/out[0]_i_1__1/O
                         net (fo=1, routed)           0.016     0.108    comb_reg/out_reg[0]_0
    SLICE_X27Y89         FDRE                                         r  comb_reg/out_reg[0]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=13, unset)           0.018     0.018    comb_reg/clk
    SLICE_X27Y89         FDRE                                         r  comb_reg/out_reg[0]/C
                         clock pessimism              0.000     0.018    
    SLICE_X27Y89         FDRE (Hold_DFF_SLICEL_C_D)
...
Min Period        n/a     FDRE/C   n/a            0.550         5.000       4.450      SLICE_X26Y88  comb_reg/done_reg/C
Low Pulse Width   Slow    FDRE/C   n/a            0.275         2.500       2.225      SLICE_X26Y88  comb_reg/done_reg/C
High Pulse Width  Slow    FDRE/C   n/a            0.275         2.500       2.225      SLICE_X26Y88  comb_reg/done_reg/C
