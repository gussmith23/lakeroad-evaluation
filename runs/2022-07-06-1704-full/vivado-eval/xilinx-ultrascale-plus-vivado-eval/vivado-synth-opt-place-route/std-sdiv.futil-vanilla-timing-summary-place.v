...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//std-sdiv.futil-vanilla-timing-summary-place.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      2.741        0.000                      0                  723        0.025        0.000                      0                  723        2.225        0.000                       0                   333  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 2.741        0.000                      0                  723        0.025        0.000                      0                  723        2.225        0.000                       0                   333  
...
Slack (MET) :             0.025ns  (arrival time - required time)
  Source:                 div/comp/quotient_msk_reg[19]/C
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Destination:            div/comp/quotient_msk_reg[18]/D
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Path Group:             clk
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=332, unset)          0.013     0.013    div/comp/clk
    SLICE_X21Y101        FDRE                                         r  div/comp/quotient_msk_reg[19]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X21Y101        FDRE (Prop_FFF_SLICEL_C_Q)
                                                      0.039     0.052 r  div/comp/quotient_msk_reg[19]/Q
                         net (fo=3, estimated)        0.039     0.091    div/comp/quotient_msk[19]
    SLICE_X21Y101        FDRE                                         r  div/comp/quotient_msk_reg[18]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=332, unset)          0.019     0.019    div/comp/clk
    SLICE_X21Y101        FDRE                                         r  div/comp/quotient_msk_reg[18]/C
                         clock pessimism              0.000     0.019    
    SLICE_X21Y101        FDRE (Hold_EFF2_SLICEL_C_D)
                                                      0.047     0.066    div/comp/quotient_msk_reg[18]
  -------------------------------------------------------------------
                         required time                         -0.066    
                         arrival time                           0.091    
  -------------------------------------------------------------------
