...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke-memory.futil-vanilla-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      4.020        0.000                      0                   15        0.037        0.000                      0                   15        2.225        0.000                       0                     9  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 4.020        0.000                      0                   15        0.037        0.000                      0                   15        2.225        0.000                       0                     9  
...
Slack (MET) :             0.037ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=8, unset)            0.013     0.013    copy0/N/clk
    SLICE_X21Y98         FDRE                                         r  copy0/N/out_reg[2]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X21Y98         FDRE (Prop_HFF_SLICEL_C_Q)
                                                      0.039     0.052 f  copy0/N/out_reg[2]/Q
                         net (fo=3, routed)           0.025     0.077    copy0/N/Q[2]
    SLICE_X21Y98         LUT5 (Prop_H5LUT_SLICEL_I2_O)
                                                      0.020     0.097 r  copy0/N/out[0]_i_1__1/O
                         net (fo=1, routed)           0.006     0.103    copy0/comb_reg/out_reg[0]_0
    SLICE_X21Y98         FDRE                                         r  copy0/comb_reg/out_reg[0]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=8, unset)            0.019     0.019    copy0/comb_reg/clk
    SLICE_X21Y98         FDRE                                         r  copy0/comb_reg/out_reg[0]/C
                         clock pessimism              0.000     0.019    
    SLICE_X21Y98         FDRE (Hold_HFF2_SLICEL_C_D)
                                                      0.047     0.066    copy0/comb_reg/out_reg[0]
  -------------------------------------------------------------------
                         required time                         -0.066    
                         arrival time                           0.103    
  -------------------------------------------------------------------
