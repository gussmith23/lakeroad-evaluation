...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//std-fp-sdiv.futil-ultrascale-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      1.236        0.000                      0                  420        0.052        0.000                      0                  420        2.225        0.000                       0                   245  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 1.236        0.000                      0                  420        0.052        0.000                      0                  420        2.225        0.000                       0                   245  
...
Slack (MET) :             0.052ns  (arrival time - required time)
  Source:                 div/comp/acc_reg[1]/C
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Destination:            div/comp/acc_reg[2]/D
                            (rising edge-triggered cell FDRE clocked by clk  {rise@0.000ns fall@2.500ns period=5.000ns})
  Path Group:             clk
  ...
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X15Y35         FDRE                                         r  div/comp/acc_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X15Y35         FDRE (Prop_DFF_SLICEL_C_Q)
                                                      0.039     0.051 r  div/comp/acc_reg[1]/Q
                         net (fo=5, routed)           0.027     0.078    div/comp/acc_reg[31]_0[1]
    SLICE_X15Y35         LUT3 (Prop_D5LUT_SLICEL_I0_O)
                                                      0.033     0.111 r  div/comp/acc[2]_i_1/O
                         net (fo=1, routed)           0.006     0.117    div/comp/acc[2]_i_1_n_0
    SLICE_X15Y35         FDRE                                         r  div/comp/acc_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=244, unset)          0.018     0.018    div/comp/clk
    SLICE_X15Y35         FDRE                                         r  div/comp/acc_reg[2]/C
                         clock pessimism              0.000     0.018    
    SLICE_X15Y35         FDRE (Hold_DFF2_SLICEL_C_D)
                                                      0.047     0.065    div/comp/acc_reg[2]
  -------------------------------------------------------------------
                         required time                         -0.065    
                         arrival time                           0.117    
  -------------------------------------------------------------------
