...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//seq.futil-vanilla-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      3.785        0.000                      0                  102        0.059        0.000                      0                  102        2.225        0.000                       0                    68  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 3.785        0.000                      0                  102        0.059        0.000                      0                  102        2.225        0.000                       0                    68  
...
Slack (MET) :             0.059ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    SLICE_X25Y96         FDRE (Prop_CFF2_SLICEL_C_Q)
                         ...
                         net (fo=1, routed)           0.071     0.123    c/D[21]
