...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke.futil-ultrascale-timing-summary-place.v
| Design            : main
...
Slack (MET) :             0.048ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X25Y133        FDRE                                         r  exp0/mul/comp/done_buf_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X25Y133        FDRE (Prop_EFF_SLICEL_C_Q)
                                                      0.039     0.052 r  exp0/mul/comp/done_buf_reg[1]/Q
                         net (fo=2, estimated)        0.062     0.114    exp0/mul/comp/done_buf_reg_n_0_[1]
    SLICE_X25Y133        FDRE                                         r  exp0/mul/comp/done_buf_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=126, unset)          0.019     0.019    exp0/mul/comp/clk
    SLICE_X25Y133        FDRE                                         r  exp0/mul/comp/done_buf_reg[2]/C
                         clock pessimism              0.000     0.019    
    SLICE_X25Y133        FDRE (Hold_EFF2_SLICEL_C_D)
