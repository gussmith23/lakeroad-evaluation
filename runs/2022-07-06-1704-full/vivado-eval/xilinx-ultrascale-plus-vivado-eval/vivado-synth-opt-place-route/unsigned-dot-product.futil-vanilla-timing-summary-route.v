...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//unsigned-dot-product.futil-vanilla-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      4.126        0.000                      0                   22        0.050        0.000                      0                   22        2.225        0.000                       0                    14  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 4.126        0.000                      0                   22        0.050        0.000                      0                   22        2.225        0.000                       0                    14  
...
Slack (MET) :             0.050ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X27Y88         FDRE                                         r  counter/out_reg[1]/C
  -------------------------------------------------------------------    -------------------
    SLICE_X27Y88         FDRE (Prop_DFF_SLICEL_C_Q)
                                                      0.039     0.051 r  counter/out_reg[1]/Q
                         net (fo=3, routed)           0.025     0.076    counter/out_reg[2]_0[1]
    SLICE_X27Y88         LUT4 (Prop_D5LUT_SLICEL_I0_O)
                                                      0.033     0.109 r  counter/out[2]_i_2/O
                         net (fo=1, routed)           0.006     0.115    counter/counter_in[2]
    SLICE_X27Y88         FDRE                                         r  counter/out_reg[2]/D
  -------------------------------------------------------------------    -------------------

                         (clock clk rise edge)        0.000     0.000 r  
                                                      0.000     0.000 r  clk (IN)
                         net (fo=13, unset)           0.018     0.018    counter/clk
    SLICE_X27Y88         FDRE                                         r  counter/out_reg[2]/C
                         clock pessimism              0.000     0.018    
    SLICE_X27Y88         FDRE (Hold_DFF2_SLICEL_C_D)
