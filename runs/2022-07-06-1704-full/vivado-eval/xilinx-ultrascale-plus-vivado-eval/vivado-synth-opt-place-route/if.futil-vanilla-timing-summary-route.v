...
| Command           : report_timing_summary -file runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//if.futil-vanilla-timing-summary-route.v
| Design            : main
...
------------------------------------------------------------------------------------------------
    ...
    -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
      4.312        0.000                      0                    6        0.055        0.000                      0                    6        2.225        0.000                       0                     4  
...
-----             -------      -------  ---------------------  -------------------      -------      -------  ---------------------  -------------------     --------     --------  ----------------------  --------------------  
clk                 4.312        0.000                      0                    6        0.055        0.000                      0                    6        2.225        0.000                       0                     4  
...
Slack (MET) :             0.055ns  (arrival time - required time)
  ...
  -------------------------------------------------------------------    -------------------
    SLICE_X26Y90         FDRE (Prop_HFF_SLICEL_C_Q)
                         ...
                         net (fo=9, routed)           0.030     0.082    comb_reg/Q[1]
    SLICE_X26Y90         LUT6 (Prop_G6LUT_SLICEL_I5_O)
                                                      0.022     0.104 r  comb_reg/out[0]_i_1__0/O
                         net (fo=1, routed)           0.016     0.120    fsm/D[0]
    SLICE_X26Y90         FDRE                                         r  fsm/out_reg[0]/D
  -------------------------------------------------------------------    -------------------
    ...
    SLICE_X26Y90         FDRE (Hold_GFF_SLICEL_C_D)
...
Min Period        n/a     FDRE/C   n/a            0.550         5.000       4.450      SLICE_X26Y90  comb_reg/done_reg/C
Low Pulse Width   Slow    FDRE/C   n/a            0.275         2.500       2.225      SLICE_X26Y90  comb_reg/done_reg/C
High Pulse Width  Slow    FDRE/C   n/a            0.275         2.500       2.225      SLICE_X26Y90  comb_reg/done_reg/C
