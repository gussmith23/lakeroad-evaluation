...
: "$EVAL_OUTPUT_DIR"
export EVAL_OUTPUT_DIR="$EVAL_OUTPUT_DIR/yosys-synth-opt-place-route-lattice-instrs"
...
for instr_file in $instr_files ; do
  ...
  time (nextpnr-ecp5 --json "$json_file" 2> "$base-nextpnr.log") 2> "$base-nextpnr.time"
